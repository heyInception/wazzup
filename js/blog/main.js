...
//const tabs = new GraphTabs('messendger');
//const tabsThanks = new GraphTabs('thanks');
//const tabsTariff = new GraphTabs('tariff');
...
createPopper(reference, tooltipTwo, {
    modifiers: [{
        name: 'offset',
        options: {
            offset: [-82, 0],
...
let thanks = new gianniAccordion({
    elements: ".thanks__accordion .thanks__item",
